    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-50 pt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <div className="inline-block p-1 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-2xl mb-8">
          ...
          <div className="mt-6 flex justify-center">
            <div className="h-1 w-32 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 rounded-full"></div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">ประเภทงาน</h3>
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-yellow-500 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
