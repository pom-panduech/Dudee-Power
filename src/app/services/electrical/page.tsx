        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            <p className="text-xl text-gray-600 leading-relaxed mb-6">
              เราให้บริการติดตั้งระบบไฟฟ้าแบบครบวงจร ครอบคลุมทั้งงานบ้านพักอาศัย อาคารพาณิชย์ และโรงงานอุตสาหกรรม โดยทีมช่างผู้ชำนาญงาน ที่มีประสบการณ์ตรงในงานติดตั้งระบบไฟฟ้ามาอย่างยาวนาน
              เรามุ่งเน้นการทำงานที่ได้มาตรฐาน ปลอดภัย และตรวจสอบได้ในทุกขั้นตอน เพื่อให้คุณมั่นใจได้ว่าระบบไฟฟ้าที่ติดตั้ง จะมีความเสถียร ใช้งานได้เต็มประสิทธิภาพ และรองรับการใช้งานในระยะยาว
            </p>
            ...
            <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl shadow-2xl p-8 border border-blue-700">
              ...
              <ul className="space-y-4 text-blue-100">
                ...
                <li className="flex items-start hover:translate-x-1 transition-all duration-200">
                  ...
                  <span className="leading-relaxed">
                    วางระบบสายไฟภายในอาคารและโรงงาน
                  </span>
                </li>
